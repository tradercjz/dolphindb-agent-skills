<!-- Auto-mirrored from upstream `documentation-main/funcs/funcs_intro.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
表示标量，向量，矩阵，字典或表的对象。我们有一些需要一个标量作为参数之一的函数，比如 take, rand, norm。对于这些情况，我们使用小写字母，比如 "a", "b". [ ] 里的内容是可选项。
