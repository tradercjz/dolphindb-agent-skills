...
创建一个包含状态列的持久化键值流数据表。参考 changelogStreamTable 和 enableTableShareAndPersistence。
...
**相关函数**：changelogStreamTable、enableTableShareAndPersistence、DStream::changelogSink
