<!-- Auto-mirrored from upstream `documentation-main/tutorials/tu_modules.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
modules/system/temperal/dateUtil.dos。这两个模块相应的声明语句分别为 `module
