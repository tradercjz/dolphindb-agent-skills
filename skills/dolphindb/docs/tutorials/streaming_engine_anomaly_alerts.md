<!-- Auto-mirrored from upstream `documentation-main/tutorials/streaming_engine_anomaly_alerts.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
