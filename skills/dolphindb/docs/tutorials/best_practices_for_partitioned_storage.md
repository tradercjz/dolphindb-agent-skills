<!-- Auto-mirrored from upstream `documentation-main/tutorials/best_practices_for_partitioned_storage.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
