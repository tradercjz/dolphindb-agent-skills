<!-- Auto-mirrored from upstream `documentation-main/tutorials/job_management_tutorial_2.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
对于定时作业和流数据作业，可分别参阅 定时作业教程 和 流数据教程 了解详情。下面详细讲述批处理作业。
