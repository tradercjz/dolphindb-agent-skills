<!-- Auto-mirrored from upstream `documentation-main/tutorials/IV_Greeks_Calculation_for_ETF_Options_Using_JIT.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
