<!-- Auto-mirrored from upstream `documentation-main/tutorials/k8s_deployment_in_Aliyun.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
销毁 Dolphindb 集群详见 k8s\_deployment。
