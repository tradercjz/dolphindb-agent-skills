<!-- Auto-mirrored from upstream `documentation-main/tutorials/streaming-real-time-correlation-processing.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
