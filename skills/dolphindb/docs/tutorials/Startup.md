<!-- Auto-mirrored from upstream `documentation-main/tutorials/Startup.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
编写启动脚本时，可以使用 `module` 来声明和使用可重用模块，可以自定义函数，也可以使用分布式的功能。
