<!-- Auto-mirrored from upstream `documentation-main/tutorials/best_practices_for_multi_factor.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
