<!-- Auto-mirrored from upstream `documentation-main/tutorials/MVO.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
qclp 全称为 Quadratically Constrained
...
socp 函数 用于求解二阶锥规划（SOCP, Second Order
