<!-- Auto-mirrored from upstream `documentation-main/tutorials/forecast_taxi_trip_dura_2.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
DolphinDB 提供了 `plot` 函数供数据可视化。用户可通过 `chartType` 指定图表类型，详见 plot。
