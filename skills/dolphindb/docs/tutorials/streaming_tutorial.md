<!-- Auto-mirrored from upstream `documentation-main/tutorials/streaming_tutorial.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
DolphinDB提供了`replay`函数，可以将历史数据按照时间顺序导入流数据表中。具体教程请参考流数据回放教程。
