<!-- Auto-mirrored from upstream `documentation-main/tutorials/fund_factor_contrasted_by_py.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
* **软件环境**
  ...
  | 软件名称 | 版本信息 | 教程&下载链接 |
  | --- | --- | --- |
  | DolphinDB | 2.00.7 | DolphinDB单节点部署教程；[DolphinDB下载链接](https://dolphindb.cn/alone/alone.php?id=10) |
