<!-- Auto-mirrored from upstream `documentation-main/tutorials/random_vibr_sig_analysis_2.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
更多时序序列数据聚合引擎和异常检测引擎相关内容请参考：DolphinDB 教程：流数据时序引擎。
