<!-- Auto-mirrored from upstream `documentation-main/tutorials/Virbration_Monitor_Fault_Diagnose.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
