<!-- Auto-mirrored from upstream `documentation-main/tutorials/public_fund_basic_analysis.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
