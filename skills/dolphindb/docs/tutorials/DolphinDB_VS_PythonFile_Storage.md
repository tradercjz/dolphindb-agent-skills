<!-- Auto-mirrored from upstream `documentation-main/tutorials/DolphinDB_VS_PythonFile_Storage.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
