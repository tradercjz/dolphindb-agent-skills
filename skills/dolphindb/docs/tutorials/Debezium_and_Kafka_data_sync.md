<!-- Auto-mirrored from upstream `documentation-main/tutorials/Debezium_and_Kafka_data_sync.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
