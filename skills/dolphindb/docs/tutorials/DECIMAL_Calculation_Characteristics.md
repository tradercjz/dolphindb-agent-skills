<!-- Auto-mirrored from upstream `documentation-main/tutorials/DECIMAL_Calculation_Characteristics.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
