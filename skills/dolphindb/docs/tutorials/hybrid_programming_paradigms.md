<!-- Auto-mirrored from upstream `documentation-main/tutorials/hybrid_programming_paradigms.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
