<!-- Auto-mirrored from upstream `documentation-main/tutorials/user_level_resource_tracking.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
