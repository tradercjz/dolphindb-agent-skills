<!-- Auto-mirrored from upstream `documentation-main/tutorials/best_practice_for_factor_calculation.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
