<!-- Auto-mirrored from upstream `documentation-main/tutorials/generate_large_scale_statistics_with_summary.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
