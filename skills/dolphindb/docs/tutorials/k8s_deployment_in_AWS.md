<!-- Auto-mirrored from upstream `documentation-main/tutorials/k8s_deployment_in_AWS.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
1. 连接 DolphinDB
   ...
   也可以通过 DolphinDB GUI 来访问此节点。DolphinDB GUI 的安装及使用请参阅 GUI 客户端。
2. 运行命令
