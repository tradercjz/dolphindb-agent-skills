<!-- Auto-mirrored from upstream `documentation-main/tutorials/Oracle_to_DolphinDB.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
* ODBC 插件
  ...
  ODBC 提供如下函数，函数的具体使用请参考 ODBC/README\_CN.md。
...
如果想自行编译，请参考： ODBC/README\_CN.md 文章中的第 2 章。
...
其他常见问题，可参考 ODBC\_plugin\_user\_guide 文章中的 “ODBC 插件使用注意事项和常见问题”一章。
