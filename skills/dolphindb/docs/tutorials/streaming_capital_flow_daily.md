<!-- Auto-mirrored from upstream `documentation-main/tutorials/streaming_capital_flow_daily.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
