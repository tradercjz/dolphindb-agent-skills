<!-- Auto-mirrored from upstream `documentation-main/db_distr_comp/db/olap.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
* [delete](../../progr/sql/delete.html "delete")
* [sqlDelete](../../funcs/s/sqlDelete.html "sqlDelete")
