<!-- Auto-mirrored from upstream `documentation-main/stream/cluster_sub.md`. Do not edit by hand; regenerate via `scripts/build_from_docs.py`. -->
...
3. 创建表 *tglobal* 的本地订阅，server 参数需设置为发布端节点名，在本例中为 dnode1； *handler*
   ...
   应根据需求合理设置，具体参数含义见subscribeTable。
